...
// Adiciona rota coringa manualmente
routes.push({
  path: '/:pathMatch(.*)*', // Captura todas as rotas não reconhecidas
  component: () => import('@/pages/error-404/index.vue'), // Página 404 personalizada
})
